...
void setup()
{
  ...
  redValue = cp5.addSlider("Red Value").setSize(80, 10).setRange(0, 255).setPosition(10, 250).setColorLabel(0).setColorBackground(255).setValue(100);
  greenValue = cp5.addSlider("Green Value").setSize(80, 10).setRange(0, 255).setPosition(10, 265).setColorLabel(0).setColorBackground(255).setValue(100);
  blueValue = cp5.addSlider("Blue Value").setSize(80, 10).setRange(0, 255).setPosition(10, 280).setColorLabel(0).setColorBackground(255).setValue(100);
